...
import com.maya.wadmin.utilities.SharedPrefsUtil;
...
public class TrackingFragment extends Fragment implements IFragment, OnMapReadyCallback
{
	                         ...
	                         Bundle savedInstanceState)
	{
		...
		if (SharedPrefsUtil.getStringPreference(getContext(), "USER_NAME") != null && !SharedPrefsUtil.getStringPreference(getContext(), "USER_NAME").isEmpty())
		{
			usertxt.setText("Name : " + SharedPrefsUtil.getStringPreference(getContext(), "USER_NAME") + "");
		}
	...
	public void startTrip()
	{
		if (isRunning == false)
		{
			Toast.makeText(getContext(), "Tracking Current location", Toast.LENGTH_SHORT).show();
